...
def upload_files():
    ...
    analysis_payload = {
        ...
        "voltage_kv":           str(int(_nearest_supported_voltage_kv(vt_p_default / 1000.0))) if vt_p_default > 1000.0 else (_s(feats.get("voltage_kv")) if feats.get("voltage_kv") else "Tidak diketahui"),
